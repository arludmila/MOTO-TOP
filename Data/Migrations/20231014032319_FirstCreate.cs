    ...
    public partial class FirstCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfficeWorker", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfficeWorker_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductHasDiscounts_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerClientVisits", x => new { x.SellerId, x.ClientId });
                    table.ForeignKey(
                        name: "FK_SellerClientVisits_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SellerClientVisits_Sellers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "Sellers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfficeWorkerId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_OfficeWorker_OfficeWorkerId",
                        column: x => x.OfficeWorkerId,
                        principalTable: "OfficeWorker",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillingTransactions_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BillingTransactions_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderProducts_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingTransactions_ClientId",
                table: "BillingTransactions",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_BillingTransactions_InvoiceId",
                table: "BillingTransactions",
                column: "InvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_OfficeWorkerId",
                table: "Invoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfficeWorker_UserId",
                table: "OfficeWorker",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_InvoiceId",
                table: "OrderProducts",
                column: "InvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellerClientVisits_ClientId",
