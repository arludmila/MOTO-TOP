...
namespace API.Controllers
{
    ...
    {
        private readonly GenericService<Seller> _service;
        public SellersController(GenericService<Seller> service)
        {
            _service = service;
        }
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] SellerDto dto)
        {
            try
            {
                var createdEntity = await _service.CreateAsync(SellerDto.Convert(dto));
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateAsync(int id, [FromBody] SellerDto dto)
        {
            try
            {
